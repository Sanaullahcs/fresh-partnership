    ...
    <div className="main-container" id="how-it-works">
      <Grid container className="property-section">
        ...
        >
          <img
            src={SuccessImage}
            alt="How Fresh Helps You Succeed"
        ...
        >
          <div className="content-wrapper-two">
            <h1 className="income-stream-headings">
              HOW FRESH HELPS YOU SUCCEED
            </h1>
            <h className="subheading-property">
              Dreaming of a new life in Spain? We make it easy to start and grow
              your own property management business, giving you the freedom to
            ...
            <div className="success-container">
              ...
              <span className="subheading-property">
                {" "}
                Follow our step-by-step system to launch quickly and
                successfully.
              </span>
              ...
              <span className="subheading-property">
                {" "}
                Learn everything you need with our 1-to-1 training, no
                experience required.
              </span>
              ...
              <span className="subheading-property">
                Automated tools and advertising to attract property owners,
                creating appointments straight into your CRM system.
              </span>
